...
import {AttributePart, defaultPartCallback, noChange, getValue, Part, SVGTemplateResult, TemplateInstance, TemplatePart, TemplateResult} from '/local/community/mod/circle-sensor-card-depends/lit-html/lit-html.js';
