...
- /local/community/mod/circle-sensor-card-depends/@polymerMixin//local/community/mod/circle-sensor-card-depends/@polymerMixinClass -> @mixinFunction/@mixinClass ([commit](https://github.com/Polymer/polymer/commit/f7e8021e))

- /local/community/mod/circle-sensor-card-depends/@polymerElement -> @customElement//local/community/mod/circle-sensor-card-depends/@polymer ([commit](https://github.com/Polymer/polymer/commit/231b21c0))
