...
[![Published on npm](https://img.shields.io/npm/v//local/community/mod/circle-sensor-card-depends/@polymer/polymer.svg)](https://www.npmjs.com/package//local/community/mod/circle-sensor-card-depends/@polymer/polymer)
[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/element//local/community/mod/circle-sensor-card-depends/@polymer/polymer)
...
```html
<!-- Import a component -->
<script src="https://unpkg.com//local/community/mod/circle-sensor-card-depends/@polymer/paper-checkbox@next/paper-checkbox.js?module" type="module" ></script>
 ...
 * When you're ready to use Polymer in a project, install it via [npm](https://www.npmjs.com/). To run the project in the browser,
 a module-compatible toolchain is required. We recommend installing the [Polymer CLI](https://github.com/Polymer/tools/tree/master/packages/cli) to and using its development server as follows.
    ...
    1. Add Polymer to your project:
        ...
        ```npm i /local/community/mod/circle-sensor-card-depends/@polymer/polymer```
    ...
    > Polymer 3.0 is published on [npm](https://www.npmjs.com/package//local/community/mod/circle-sensor-card-depends/@polymer/polymer) using JavaScript Modules.
...
```html
  ...
  <script type="module">
    import {PolymerElement, html} from '/local/community/mod/circle-sensor-card-depends/@polymer/polymer';
