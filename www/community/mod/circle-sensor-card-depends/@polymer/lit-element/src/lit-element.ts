...
} from '/local/community/mod/circle-sensor-card-depends/@polymer/polymer/lib/mixins/properties-changed.js';
...
} from '/local/community/mod/circle-sensor-card-depends/@polymer/polymer/lib/mixins/properties-mixin.js';
